...
export PATH="$PATH:/opt/nvim-linux64/bin:/mnt/home/files/bin:/opt/android-studio/bin"
eval "$(zoxide init zsh)"

#export PATH="$GEM_HOME/bin:/root/.rvm/bin:$PATH" # Add RVM to PATH for scripting
